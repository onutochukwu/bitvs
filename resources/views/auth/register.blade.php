        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    ...
                    <input name="password" type="password" class="form-control form-control-lg @error('password') error @enderror" id="password" placeholder="Enter your password">
                    @error('password')
                    <span id="fv-full-name-error" class="invalid">
                        {{ $message }}
                    </span>
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    ...
                    <input name="password_confirmation" type="password" class="form-control form-control-lg" id="cpassword" placeholder="Confirm your password">
                </div>
            </div>
            <div class="form-group">
                <div class="custom-control custom-control-xs custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="checkbox">
                    <label class="custom-control-label" for="checkbox">I agree to BITVs <a href="#">Privacy Policy</a> &amp; <a href="#"> Terms.</a></label>
                </div>
            </div>
            <div class="form-group">
